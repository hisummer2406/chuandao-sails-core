...
// 查询订单
func ChdGetOrderHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChdGetOrderRequest
		...
		l := chd.NewChdGetOrderLogic(r.Context(), svcCtx)
		resp, err := l.ChdGetOrder(&req)
