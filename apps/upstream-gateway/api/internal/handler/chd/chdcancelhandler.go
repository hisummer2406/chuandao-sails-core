...
// 订单取消
func ChdCancelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChdCancelRequest
		...
		l := chd.NewChdCancelLogic(r.Context(), svcCtx)
		resp, err := l.ChdCancel(&req)
