...
import (
	...
	chd "chuandao-sails-core/apps/upstream-gateway/api/internal/handler/chd"
	sf "chuandao-sails-core/apps/upstream-gateway/api/internal/handler/sf"
	uu "chuandao-sails-core/apps/upstream-gateway/api/internal/handler/uu"
		...
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				},
				{
					...
					Handler: uu.UuGatewayHandler(serverCtx),
				},
				{
					// 订单回推
					Method:  http.MethodPost,
